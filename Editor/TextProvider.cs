...
namespace AmazonGameLift.Editor
{
    internal sealed class TextProvider
    {
        ...
        private readonly Dictionary<string, string> _textsByKey = new Dictionary<string, string>
        {
            ...
            { Strings.ManagedEC2ScenarioSpotFleetLabel, "Spot Fleet"},
            { Strings.ManagedEC2ScenarioSpotFleetRadio, "Forms matches by using Amazon GameLift queues and a custom matchmaker and configures three fleets."},
            { Strings.ManagedEC2ScenarioSpotFleetLink, "Learn more"},
